    ...
    if (isset($_SESSION['user'])) {
    	header("Location:home.php");
                                	...
                                	if ($login >0) {
                                        ...
                                        $_SESSION['company_serial']=$details['company_serial'];
                                        $_SESSION['user-role']=$details['user_role'];
                                		header("Location:home.php");
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST">
                                ...
                                <fieldset style=""><legend style="color: darkgrey;"><center>OR</center> </legend>
                                    <a href="forgot.php" style="color: red;font-weight: bold;text-align: center;">Forgot Password? </a></fieldset>
                            </form>
                        </div>
                    </div>
                </div>
