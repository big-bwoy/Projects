...
<div class="app-title" style="margin-top: 0.33px;">
        <div>
          <h1><i class="fa fa-line-chart"></i> Reports/ Received</h1>
  ...
  <div class="col-sm-12 col-md-12 col-xs-12 col-lg-12">
    ...
    <div class="table-responsive">
      <table id="tb1" class="table" style="width: 100%;">
	   ...
	   <form method="post" action="export_recived_meters.php">
...
<div class="table-responsive">
	  ...
	  <form method="post" action="export_recived_coils.php">
     <input type="submit" name="export" class="btn btn-success" value="Export to excel" />
    </form>
    </div>
...
<div id="tb3" class="table-responsive">
      <table class="table" style="width: 100%;">
	   ...
	   <form method="post" action="export_recived_seals.php">
     <input type="submit" name="export" class="btn btn-success" value="Export to excel" />
    </form>
    </div> 
