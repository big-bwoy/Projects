...
<div class="app-title" style="margin-top: 0.33px;">
        <div>
          <h1><i class="fa fa-line-chart"></i> Reports / Dispatchment</h1>
...
<div class="row">
  ...
  <div class="col-sm-12 col-md-12 col-xs-12 col-lg-12">
    ...
    <div style="margin-bottom: 16px;border-bottom: 1px solid grey;" class="page-header"><h3>Meter Sales</h3></div>
    <div class="table-responsive">
      <table id="tb1" class="table" style="width: 100%;">
        ...
        <tbody>
          ...
          for ($i=0; $i <count($t) ; $i++) { 
            ?>
            <tr>
              <td><?php echo $t[$i]['receipt_date']; ?></td>
              <td><?php echo $t[$i]['receipt_number']; ?></td>
	  ...
	  <form method="post" action="export_disptached_meters.php">
     <input type="submit" name="export" class="btn btn-success" value="Export to excel" />
    </form>
    </div>


<div style="margin-top:34px;margin-bottom: 16px;border-bottom: 1px solid grey;" class="page-header"><h3>Coil Sales</h3></div>
...
<div class="table-responsive">
      <table id="tb2" class="table" style="width: 100%;">
        ...
        <tbody>
          ...
          for ($i=0; $i <count($t) ; $i++) { 
            ...
            <tr>
              <td><?php echo $t[$i]['receipt_date']; ?></td>
              <td><?php echo $t[$i]['move_out_receipt_no']; ?></td>
	  ...
	  <form method="post" action="export_disptached_coils.php">
     <input type="submit" name="export" class="btn btn-success" value="Export to excel" />
    </form>
    </div>

<div style="margin-top:34px;margin-bottom: 16px;border-bottom: 1px solid grey;" class="page-header"><h3>Seal Sales</h3></div>
...
<div id="tb3" class="table-responsive">
	  ...
	  <form method="post" action="export_disptached_seals.php">
     <input type="submit" name="export" class="btn btn-success" value="Export to excel" />
    </form>
    </div>
